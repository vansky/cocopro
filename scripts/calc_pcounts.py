...
#    continue
  ...
  if USE_SENTS:
    ...
    full_joint_counts[pro][ref,coh,sent_topic,sent_info] = full_joint_counts[pro].get((ref,coh,sent_topic,sent_info), 0) + 1
    marginal_counts[ref,coh,sent_topic,sent_info] = marginal_counts.get((ref,coh,sent_topic,sent_info), 0) + 1
    ...
    full_joint_counts[ref][coh,sent_topic] = full_joint_counts[ref].get((coh,sent_topic), 0) + 1
    marginal_counts[coh,sent_topic] = marginal_counts.get((coh,sent_topic), 0) + 1
