#calc_pcounts.py --coco-corpus FILE --topics FILE --sentences FILE --vectors FILE --output FILE
...
for d in (pro_from_ref, pro_from_coh, pro_from_top, pro_from_sent, pro_from_ant, ref_from_coh, ref_from_top):
